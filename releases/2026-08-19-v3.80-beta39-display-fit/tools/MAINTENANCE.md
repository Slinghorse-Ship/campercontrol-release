...
Der Bericht prüft Firmware/Architektur, freien Speicher, `rc.local` sowie
`rc.local.disabled`, die persistente Releasekopie, GX/WASM-Hashes, 358 Node-RED-
Nodes, Flow/API, CamperControl-D-Bus, FlashMQ/GXdbus/GXrpc/VRM, Orion und
Shelly/INDEVOLT sowie komprimierte Backups. Ein stromloser Shelly bei
...
einen vorhandenen `/tmp`-Stage. Nach einem Venus-Update kann `/data/rc.local` in
...
VRM-Transportvertrag und der reale 800 × 480-Touch-/Viewport-Test. Danach
