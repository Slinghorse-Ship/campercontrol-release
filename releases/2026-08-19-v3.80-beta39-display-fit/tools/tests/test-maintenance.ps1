...
try {
    ...
    foreach ($required in @('-Apply', '-Build', 'ForceFirmwareMismatch', 'create-preapply-backup.sh', 'build-gx.sh', 'build-wasm.sh', 'camper_vrm_transport_contract.py', 'smoke_test.py')) {
    ...
    if ($parsedMatrix.knownFirmware[0].guiRepositoryCommit -ne '2118cc7333663d21206f88701806fb0e7bdb60f3') {
